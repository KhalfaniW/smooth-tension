...
export function HoldTensionBox({children}) {
  ...
  return (
    <div className=" text-xl pb-3 px-8 py-3 font-semibold  bg-red-500 text-coolGray-100 ">
      {children}
    </div>
  );
}
export function ReleaseTensionBox({children}) {
  return (
    <div className=" text-xl px-8 py-3 font-semibold rounded-full bg-blue-500 text-coolGray-100 ">
      {children}
    </div>
  );
}
